...
> = () => {
  ...
  useEffect(() => {
    // Note: Session integration removed as next-auth is not installed
    // If authentication is needed, install next-auth and uncomment:
    ...
    //   })
    // }
  }, [formData.socialXUseSession, dispatch])
      ...
      <form onSubmit={handleFormSubmit} className="space-y-4">
        ...
        <div>
          ...
          <input
            ...
            onBlur={handleBlur}
            className={`w-full rounded-lg border-1 p-2  text-[#000] ${
              errors.receiptEmail
                ? 'border-red-600 '
            ...
            <div className="flex flex-col gap-y-2">
              ...
              <div className="relative flex w-full flex-col space-y-3">
                <input
                  ...
                  className={`flex w-full rounded-lg border-1 p-2 !text-black ${
                    errors.country
                      ? 'border-red-600'
                      : 'border-[#222222] bg-[#f0f0f0]'
                  }`}
              ...
              <input
                ...
                onChange={handleChange}
                className="w-full rounded-lg border-1 border-[#222222] bg-[#f0f0f0] p-2  text-[#000]"
              />
              <div className="flex flex-row gap-x-2">
                <div className="w-full">
                  <input
