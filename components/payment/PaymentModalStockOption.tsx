  ...
  return (
    <div className="relative flex w-full flex-col space-y-3 pt-5">
      <input
        ...
        className="flex w-full rounded-lg border-1 border-[#222222] bg-[#f0f0f0] p-2 text-left font-space-grotesk font-semibold text-[#222222]"
        onFocus={() => {
          if (!displayedStock) {
            setShowDropdown(true)
          }
      ...
      {showDropdown && filteredStocks.length > 0 && (
        <ul
          className="absolute top-12 max-h-56 w-full overflow-y-auto rounded-lg border-1 border-black bg-[#f0f0f0] text-[#222222]"
          style={{ zIndex: 10 }}
        >
